                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="date" name="date_start" id="date_start" class="form-control" placeholder="" value="{{ $formation->date_start }}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="date_end">End Date </label>
                                                            <input type="date" name="date_end" class="form-control" placeholder="" value="{{ $formation->date_end }}">
                                                        </div>
                                                    </div>
                                                </div>
